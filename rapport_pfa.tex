...
Afin d'offrir une vision à 360 degrés de la progression de l'étudiant, le Sprint~4 a été enrichi d'un module d'analytique avancée. Ce dispositif transforme les données brutes de quiz en indicateurs de performance (KPIs) exploitables, visualisés à travers un tableau de bord haute fidélité accessible aux \textbf{enseignants} et aux \textbf{administrateurs}.
...
POST & /api/detect-weak-topics & Détection lacunes & IA / Service \\
GET  & /api/admin/users & Liste des utilisateurs & ADMIN \\
GET  & /api/admin/users/\{id\} & Détails analytiques étudiant & ADMIN / TEACHER \\
